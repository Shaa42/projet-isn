...
background_image = pygame.image.load("fond.png").convert()
background_image = pygame.transform.scale(background_image, (WIDTH, HEIGHT))
ile_image = pygame.image.load("ile.png").convert()
ile_image = pygame.transform.scale(ile_image, (ILE_WIDTH, ILE_HEIGHT))

icon_size = int(40 * min(SCALE_X, SCALE_Y))
icon_eau = pygame.transform.scale(pygame.image.load("eau.png").convert_alpha(), (icon_size, icon_size))
icon_poisson = pygame.transform.scale(pygame.image.load("poisson.png").convert_alpha(), (icon_size, icon_size))
icon_arbre = pygame.transform.scale(pygame.image.load("arbre.png").convert_alpha(), (icon_size, icon_size))
bois_fond = pygame.image.load("bois_fond.png").convert()
...
def draw_interface():
    ...
    if selected_zone:
        try:
            image = pygame.image.load(selected_zone + ".png").convert_alpha()
    ...
    journal_img = pygame.image.load("journal_fond.png").convert_alpha()
